...
export const CONTRACTS = {
  views: {
    ...
    analysisLeakageLines: "cms_v_an_leakage_lines_v1",
    analysisSalesRfm: "cms_v_an_sales_rfm_v1",
    analysisIntegrityPreflight: "v_cms_ar_sot_preflight_v1",
    analysisIntegrityLabor: "v_cms_shipment_labor_integrity_v1",
    analysisInventoryExceptions: "cms_v_inventory_exceptions_v1",
  ...
  functions: {
    ...
    analysisLeakageSummary: "cms_fn_an_leakage_summary_v1",
    analysisOverviewSummary: "cms_fn_an_overview_summary_v1",
    analysisPartyRecoPreview: "cms_fn_an_party_reco_preview_v1",
    analysisMarketHealthSummary: "cms_fn_an_market_health_summary_v1",
    analysisIntegritySnapshot: "cms_fn_an_integrity_snapshot_v1",
    arSotMonitoringSnapshot: "cms_fn_ar_sot_monitoring_snapshot_v1",
    shipmentLaborIntegritySummary: "cms_fn_shipment_labor_integrity_summary_v1",
