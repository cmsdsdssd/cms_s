...
const SELECT_COLUMNS =
  "master_id, model_name, labor_base_sell, labor_base_cost, labor_center, labor_center_sell, labor_center_cost, labor_side1, labor_sub1_sell, labor_sub1_cost, labor_side2, labor_sub2_sell, labor_sub2_cost, center_qty_default, sub1_qty_default, sub2_qty_default, plating_price_cost_default, plating_price_sell_default";
...
export async function GET(request: Request) {
  ...
  if (masterId) {
    ...
    if (byId.data) return NextResponse.json({ data: byId.data });
  }
  ...
  if (byModelExact.data) return NextResponse.json({ data: byModelExact.data });
  ...
  if (byModelInsensitive.data) return NextResponse.json({ data: byModelInsensitive.data });
