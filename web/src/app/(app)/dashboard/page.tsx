...
const kpis = [
  ...
  { label: "출고 매출", value: "₩4,800,000" },
  { label: "미수 잔액", value: "₩2,320,000" },
  ...
  return (
    <div className="space-y-6" id="dashboard.root">
      ...
      <FilterBar id="dashboard.filterBar">
        <Button variant="ghost" size="sm">최근 7일</Button>
        <Button variant="ghost" size="sm">최근 30일</Button>
        <Button variant="ghost" size="sm">기간 설정</Button>
      </FilterBar>
