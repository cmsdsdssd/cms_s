...
$$;
grant execute on function cms_fn_upsert_vendor_prefix(uuid, text, text) to authenticated;
grant execute on function cms_fn_upsert_vendor_prefix(uuid, text, text) to service_role;
