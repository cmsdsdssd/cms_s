-- cms_0024: add is_active to cms_fn_upsert_party_v1
...
begin
  ...
  insert into public.cms_party(
    party_id, party_type, name, phone, region, address, note, is_active
  )
  values (
    v_id,
    p_party_type,
  ...
  on conflict (party_id) do update set
    ...
    note       = excluded.note,
    is_active  = case
      when p_is_active is null then cms_party.is_active
