...
-- ------------------------------------------------------------
-- cms_0258: RESTORE confirm_shipment to repo version (cms_0248)
--
-- Fixes runtime errors like:
--   42703 record "r_master" has no field "labor_basic_sell_krw"
-- Root cause:
--   cms_master_item schema uses labor_base_sell / labor_base_cost ... (no *_sell_krw columns)
--   Some patched versions referenced non-existent fields.
--
-- This migration replaces public.cms_fn_confirm_shipment(uuid,uuid,text)
-- with the repo's canonical cms_0248 implementation.
-- ------------------------------------------------------------
