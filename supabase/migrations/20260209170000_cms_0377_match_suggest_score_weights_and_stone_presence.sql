  ...
  scored as (
    select
      ...
      (
        ...
        +
        (case when v_material is not null and o.material_code is not null and o.material_code = v_material then 15 else 0 end)
        +
        (case when v_size is not null and o.size is not null and o.size = v_size then 10 else 0 end)
        +
        (case when v_color is not null and o.color is not null and upper(o.color)=upper(v_color) then 10 else 0 end)
      ...
      jsonb_build_object(
        ...
        'stone_presence', jsonb_build_object(
          'center', o.stone_center_exists,
          'sub1', o.stone_sub1_exists,
          'sub2', o.stone_sub2_exists
        )
      ) as match_reason
    from orders o
    where
