...
-- cms_1210_shop_rule_only_mapping_write_rpc
...
begin
  ...
  from (
    select
      ...
      null::numeric(18,6) as material_multiplier_override,
      null::numeric(18,6) as size_weight_delta_g,
      false as size_price_override_enabled,
      null::integer as size_price_override_krw,
      null::numeric(18,0) as option_price_delta_krw,
      'SYNC'::text as option_price_mode,
      null::numeric(14,2) as option_manual_target_krw,
      true as include_master_plating_labor,
      true as sync_rule_material_enabled,
      true as sync_rule_weight_enabled,
      true as sync_rule_plating_enabled,
      true as sync_rule_decoration_enabled,
      true as sync_rule_margin_rounding_enabled,
