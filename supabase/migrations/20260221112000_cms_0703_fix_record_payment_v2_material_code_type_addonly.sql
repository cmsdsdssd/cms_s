-- cms_0703: fix cms_fn_record_payment_v2 material factor lookup type mismatch
-- Root cause: p_material_code was handled as text and passed to cms_fn_get_material_factor_v2(cms_e_material_code).
