...
-- category resolve
    ...
    if v_material is null or v_material = '00' then
      ...
      if v_material in ('14','18','24') then
        ...
        v_material_amount_sell := round(v_silver_price * v_silver_purity * v_silver_adjust_factor_applied * v_net, 0);
      else
        v_material_amount_sell := 0;
      end if;
    ...
    set
      ...
      silver_adjust_factor = case when r_master.material in ('925') then v_silver_factor_snapshot else r_line.silver_adjust_factor end,
      ...
      price_calc_trace = jsonb_build_object(
        ...
        'gold_tick', jsonb_build_object(
          'symbol', v_gold_symbol,
          'tick_id', v_gold_tick_id,
          'krw_per_g', v_gold_price,
          'observed_at', v_gold_observed_at
        ),
        'silver_tick', jsonb_build_object(
          'symbol', v_silver_symbol,
          'tick_id', v_silver_tick_id,
          'krw_per_g', v_silver_price,
          'observed_at', v_silver_observed_at
        ),
        'silver_purity', v_silver_purity,
        'silver_adjust_factor_cfg', v_silver_factor_snapshot,
        'cs_correction_factor_cfg_cn', v_cs_correction_factor_cfg,
        'silver_kr_correction_factor_cfg', v_silver_kr_correction_factor_cfg,
        'silver_adjust_factor_applied', v_silver_adjust_factor_applied,
