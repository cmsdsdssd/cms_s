-- fix: cms_fn_upsert_order_line_v3 was writing 'MATCHED' which is not a valid cms_e_match_state
create or replace function public.cms_fn_upsert_order_line_v3(
  ...
  p_priority_code cms_e_priority_code default 'NORMAL'::cms_e_priority_code,
  p_source_channel text default null,
  p_memo text default null,
  p_order_line_id uuid default null,
  p_center_stone_name text default null,
  p_center_stone_qty integer default null,
  p_sub1_stone_name text default null,
  p_sub1_stone_qty integer default null,
  p_sub2_stone_name text default null,
  p_sub2_stone_qty integer default null,
...
begin
  ...
  values(
    ...
    p_sub2_stone_qty,
    p_master_id,
    'HUMAN_CONFIRMED'::cms_e_match_state,   -- ✅ FIX
    p_actor_person_id,
    now()
  )
